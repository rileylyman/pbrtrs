pub use crate::geometry::numeric::*;
use std::ops;
    ...
    T: Numeric,
{
    ...
    pub fn min_component(&self) -> (usize, T) {
    ...
    pub fn max_component(&self) -> (usize, T) {
    ...
    pub fn face_towards_same_hemisphere(&self, other: &Self) -> Self {
    ...
    T: NumericFloat,
{
    ...
    pub fn cos_theta(&self, other: &Self) -> T {
        self.dot(other) / self.mag() / other.mag()
    }

    pub fn theta(&self, other: &Self) -> T {
    ...
    pub fn lerp(&self, t: T, other: &Self) -> Self {
        *self - *self * t + *other * t
    }
...
where
    T: Numeric,
{
    pub fn elements(x: T, y: T, z: T) -> Self {
        Self { data: [x, y, z] }
    }
    pub fn x(&self) -> T {
        self.data[0]
...
where
    T: NumericFloat,
{
    pub fn sin_theta(&self, other: &Self) -> T {
        self.cross(other).mag() / self.mag() / other.mag()
    }

    pub fn spanning_set(&self) -> (Self, Self, Self) {
...
where
    T: Numeric,
{
    pub fn elements(x: T, y: T, z: T, w: T) -> Self {
        Self { data: [x, y, z, w] }
    }
    pub fn x(&self) -> T {
        self.data[0]
